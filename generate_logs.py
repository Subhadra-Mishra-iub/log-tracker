...
def main():
    ...
    log_files = [
        ('logs/application.log', 50000, 0.03),
        ('logs/database.log', 30000, 0.08),
        ('logs/system.log', 25000, 0.05),
        ('logs/security.log', 15000, 0.12),
        ('logs/performance.log', 40000, 0.04),
        ('logs/error.log', 20000, 0.15),
        ('logs/access.log', 100000, 0.02),
        ('logs/combined.log', 200000, 0.06),
    ]
